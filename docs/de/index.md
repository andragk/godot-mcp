...
Besuchen Sie `http://localhost:3000` für umfassende Überwachung und Steuerung:
...
**Zugriff:** Browser öffnen unter `http://localhost:3000`, während der MCP-Server läuft.
