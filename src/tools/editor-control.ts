...
export class EditorControlTools {
  constructor(private readonly godotClient: GodotClient) {}

  /**
   * Launch Godot editor for a project
   */
  async launchEditor(args: z.infer<typeof LaunchEditorSchema>): Promise<unknown> {
    try {
   ...
   * Run a Godot project
   */
  async runProject(args: z.infer<typeof RunProjectSchema>): Promise<unknown> {
    try {
   ...
   */
  async stopExecution(args: z.infer<typeof StopExecutionSchema>): Promise<unknown> {
    try {
   ...
   * Get Godot version
   */
  async getVersion(args: z.infer<typeof GetVersionSchema>): Promise<unknown> {
    try {
   ...
   */
  async listProjects(args: z.infer<typeof ListProjectsSchema>): Promise<unknown> {
    try {
   ...
   */
  async analyzeProject(args: z.infer<typeof AnalyzeProjectSchema>): Promise<unknown> {
    try {
